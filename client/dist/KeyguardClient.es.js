...
class KeyguardClient {
    ...
    signStaking(request) {
        this._redirectRequest(KeyguardCommand.SIGN_STAKING, request);
    }
...
export { KeyguardClient, MSG_PREFIX, RequestBehavior, RedirectRequestBehavior, IFrameRequestBehavior, SwapIFrameRequestBehavior, KeyguardCommand, Errors, BitcoinTransactionInputType };
